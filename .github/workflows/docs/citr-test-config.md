...
| XTS HAPI Tests (Block Node Communication) | [CALL: Execute HAPI Tests](/.github/workflows/zxc-execute-hapi-tests.yaml)                        | `enable-hapi-tests-bn-communication: true`<br/>`enable-hapi-tests-bn-sim-communication: true`<br/>`enable-network-log-capture: true`<br/>`ref: <commit-sha>`                                                                                                                                                                | `access-token`<br/>`gradle-cache-username`<br/>`gradle-cache-password`                                                                                                                                                                                   | Fetch XTS Candidate<br/>Compile Code |
